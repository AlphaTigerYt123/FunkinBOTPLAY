...
class PlayState extends MusicBeatSubState
{
  ...
  **/
  ...
  override function stepHit():Bool
  {
    ...
    if (!startingSong
      && FlxG.sound.music != null
      && (Math.abs(FlxG.sound.music.time - (Conductor.instance.songPosition + Conductor.instance.instrumentalOffset)) > 75
        || Math.abs(vocals.checkSyncError(Conductor.instance.songPosition + Conductor.instance.instrumentalOffset)) > 75))
    {
